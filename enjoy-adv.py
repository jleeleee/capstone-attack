...
def parse_args():
    ...
    parser.add_argument("--threshhold", type=str, default=None, help="Strategically timed threshhold.")
    ...
    boolean_flag(parser, "timed", default=False, help="whether or not to NoisyNetwork")
...
def play(env, act, craft_adv_obs, craft_adv_obs2, stochastic, video_path, attack, m_target, m_adv):
    ...
    while True:
        ...
        video_recorder.capture_frame(); num_moves += 1
    #V: Attack #
        if attack != None:
            # Craft adv. examples
